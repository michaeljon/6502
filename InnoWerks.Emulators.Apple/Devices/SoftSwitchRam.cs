    ...
    public sealed class SoftSwitchRam : IDevice
    {
        ...
        public byte Read(ushort address)
        {
            switch (address)
            {
                ...
                case SoftSwitch.PAGE2OFF: Page2 = false; return 0;
                case SoftSwitch.PAGE2ON: Page2 = true; return 0;

                // IIe video / identification
                case SoftSwitch.HIRESOFF: return 0x00;  // no mixed mode (or whatever default)
                case SoftSwitch.HIRESON: return 0x00;  // no 80-column card installed

                // IIe aux memory
                case SoftSwitch.RAMRDOFF: AuxRead = false; return 0;
        ...
        public void Write(ushort address, byte value)
        {
            switch (address)
            {
                ...
                case SoftSwitch.PAGE2OFF: Page2 = false; break;
                case SoftSwitch.PAGE2ON: Page2 = true; break;

                case SoftSwitch.HIRESOFF: /* typically write ignored */ break;
                case SoftSwitch.HIRESON: /* typically write ignored */ break;

                // Aux memory
                case SoftSwitch.RAMRDOFF: AuxRead = false; break;
                case SoftSwitch.RAMDRON: AuxRead = true; break;
                case SoftSwitch.RAMWRTOFF: AuxWrite = false; break;
                case SoftSwitch.RAMWRTON: AuxWrite = true; break;
