    ...
    public static class InstructionInformation
    {
        ...
        public static readonly IDictionary<(OpCode opCode, AddressingMode addressingMode), (byte code, CpuClass minCpuClass)> Instructions =
            new Dictionary<(OpCode opCode, AddressingMode addressingMode), (byte code, CpuClass minCpuClass)>
            {
                ...
                {(OpCode.CLC, AddressingMode.Implied), (0x18, CpuClass.WDC6502) },
                ...
                {(OpCode.SEC, AddressingMode.Implied), (0x38, CpuClass.WDC6502) },
                ...
                {(OpCode.CLI, AddressingMode.Implied), (0x58, CpuClass.WDC6502) },
                ...
                {(OpCode.SEI, AddressingMode.Implied), (0x78, CpuClass.WDC6502) },
                ...
                {(OpCode.DEY, AddressingMode.Implied), (0x88, CpuClass.WDC6502) },
                {(OpCode.BIT, AddressingMode.Immediate), (0x89, CpuClass.WDC65C02) },
                {(OpCode.TXA, AddressingMode.Implied), (0x8a, CpuClass.WDC6502) },
                // unassigned
                ...
                {(OpCode.TYA, AddressingMode.Implied), (0x98, CpuClass.WDC6502) },
                {(OpCode.STA, AddressingMode.AbsoluteYIndexed), (0x99, CpuClass.WDC6502) },
                {(OpCode.TXS, AddressingMode.Implied), (0x9a, CpuClass.WDC6502) },
                // unassigned
                ...
                {(OpCode.TAY, AddressingMode.Implied), (0xa8, CpuClass.WDC6502) },
                {(OpCode.LDA, AddressingMode.Immediate), (0xa9, CpuClass.WDC6502) },
                {(OpCode.TAX, AddressingMode.Implied), (0xaa, CpuClass.WDC6502) },
                // unassigned
                ...
                {(OpCode.CLV, AddressingMode.Implied), (0xb8, CpuClass.WDC6502) },
                {(OpCode.LDA, AddressingMode.AbsoluteYIndexed), (0xb9, CpuClass.WDC6502) },
                {(OpCode.TSX, AddressingMode.Implied), (0xba, CpuClass.WDC6502) },
                // unassigned
                ...
                {(OpCode.INY, AddressingMode.Implied), (0xc8, CpuClass.WDC6502) },
                {(OpCode.CMP, AddressingMode.Immediate), (0xc9, CpuClass.WDC6502) },
                {(OpCode.DEX, AddressingMode.Implied), (0xca, CpuClass.WDC6502) },
                {(OpCode.WAI, AddressingMode.Implied), (0xcb, CpuClass.WDC65C02) },
                ...
                {(OpCode.INX, AddressingMode.Implied), (0xe8, CpuClass.WDC6502) },
                {(OpCode.SBC, AddressingMode.Immediate), (0xe9, CpuClass.WDC6502) },
                {(OpCode.NOP, AddressingMode.Implied), (0xea, CpuClass.WDC6502) },
                // unassigned
                ...
                {(OpCode.SED, AddressingMode.Implied), (0xf8, CpuClass.WDC6502) },
